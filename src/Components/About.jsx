        ...
        <div className={`about h-full  bg-[#0f1624]`}>
            <div className="content h-full  flex flex-col">
                <motion.h1
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ delay: 16.2, duration: 1.5, ease: 'easeInOut' }}
                ...
                <div className=' h-full mt-5 flex min-[768px]:justify-center'>
                    <div className='dates  w-28 flex flex-col items-center  min-[768px]:w-[10rem]  min-[1440px]:w-[12rem]'>
                        <motion.p
                            initial={{ x: "-100vw" }}
                            animate={{ x: 0 }}
                            transition={{ delay: 27.6, duration: 3.5, ease: 'easeInOut' }}
                        ...
                        <motion.p
                            initial={{ x: "-100vw" }}
                            animate={{ x: 0 }}
                            transition={{ delay: 25, duration: 3.5, ease: 'easeInOut' }}
                        ...
                        <motion.p
                            initial={{ x: "-100vw" }}
                            animate={{ x: 0 }}
                            transition={{ delay: 22.4, duration: 3.5, ease: 'easeInOut' }}
                        ...
                        <motion.p
                            initial={{ x: "-100vw" }}
                            animate={{ x: 0 }}
                            transition={{ delay: 19.8, duration: 3.5, ease: 'easeInOut' }}
                    ...
                    <motion.div
                        ...
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 20.8, duration: 1.2, ease: 'easeInOut' }}
                        ...
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 19.8, duration: 1.2, ease: 'easeInOut' }}
                        ...
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 18.8, duration: 1.2, ease: 'easeInOut' }}
                        ...
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 17.8, duration: 1.2, ease: 'easeInOut' }}
                    ...
                    <div className='desc  w-56 min-[375px]:w-[22rem] space-y-8 flex flex-col items-center px-6  min-[768px]:w-[32rem] min-[768px]:space-y-16 min-[1440px]:w-[35rem]'>
                        <motion.p
                            initial={{ x: "100vw" }}
                            animate={{ x: 0 }}
                            transition={{ delay: 29.2, duration: 3.5, ease: 'easeInOut' }}
                        ...
                        <motion.p
                            initial={{ x: "100vw" }}
                            animate={{ x: 0 }}
                            transition={{ delay: 26.6, duration: 3.5, ease: 'easeInOut' }}
                        ...
                        <motion.p
                            initial={{ x: "100vw" }}
                            animate={{ x: 0 }}
                            transition={{ delay: 24, duration: 3.5, ease: 'easeInOut' }}
                        ...
                        <motion.p
                            initial={{ x: "100vw" }}
                            animate={{ x: 0 }}
                            transition={{ delay: 21.3, duration: 3.5, ease: 'easeInOut' }}
