        ...
        <>
            <div className={`home   h-full min-[768px]:h-screen  bg-[#0f1624] `}>
                ...
                <motion.div
                    ...
                    className="content h-full flex flex-col items-center min-[768px]:flex-row min-[768px]:justify-center min-[768px]:items-start min-[768px]:mt-24  min-[768px]:px-8  min-[1024px]:mt-24 min-[1440px]:mt-32 ">
                    <div className='flex flex-col justify-center  w-[17rem]  h-[20rem] z-10  min-[425px]:w-[20rem] min-[768px]:w-[24rem]  min-[1024px]:w-[34rem] min-[1440px]:w-[40rem] '>
                        ...
                        <motion.a
                            initial={{ x: "-100vw" }}
                            animate={{ x: 0 }}
                            transition={{ duration: 2, ease: 'easeInOut', delay: 4.4 }}
                            viewport={{ once: true }}
